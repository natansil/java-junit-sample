...
import com.google.devtools.build.lib.testutil.Classpath;
import com.google.devtools.build.lib.testutil.Classpath.ClassPathException;
...
public final class TestSuiteBuilder {
  ...
  private static boolean isJunit4Test(Class<?> container) {
    ...
    return isTestMethod || container.isAnnotationPresent(RunWith.class);
  }
